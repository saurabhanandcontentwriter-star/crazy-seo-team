        ...
        <CardContent className="p-5 md:p-8">
          ...
          <div className="grid gap-6">
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="grid gap-2"><Label>Subject</Label><Select value={subject} onValueChange={v => setSubject(v)}><SelectTrigger className="h-12 rounded-xl"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="Tech">Tech</SelectItem><SelectItem value="AI">AI</SelectItem><SelectItem value="SEO">SEO</SelectItem><SelectItem value="Travel">Travel</SelectItem><SelectItem value="Science">Science</SelectItem><SelectItem value="Economics">Economics</SelectItem><SelectItem value="Other">Other</SelectItem></SelectContent></Select></div><div className="grid gap-2 md:col-span-3"><Label>Creator Subject <span className="font-normal text-muted-foreground">(select your creator category)</span></Label><Select value={creatorType} onValueChange={v=>setCreatorType(v)}><SelectTrigger className="h-12 rounded-xl"><SelectValue placeholder="Select Creator Subject" /></SelectTrigger><SelectContent>{CREATOR_TYPES.map(t=><SelectItem key={t.key} value={t.key}>{t.icon} {t.label}</SelectItem>)}</SelectContent></Select><p className="text-xs text-muted-foreground">Choose one: 💻 Tech Creator, 🤖 AI Creator, 🔍 SEO Creator, 📈 Marketing Creator, 🎨 Design Creator, 🧑‍💻 Developer Creator, 📝 Content Creator, 🎥 Video Creator, 📚 Education Creator, 💼 Business Creator, 🌐 Digital Creator, ⚡ Productivity Creator, 🛠️ SaaS Creator, 📊 Data Creator, 🧠 Knowledge Creator.</p></div>
            </div>
