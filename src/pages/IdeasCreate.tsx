        ...
        <CardContent className="p-5 md:p-8">
          ...
          <div className="grid gap-6">
            ...
            <div className="grid gap-2">
              ...
              <div className="grid gap-3"><label className="flex min-h-28 cursor-pointer items-center justify-center gap-3 rounded-2xl border border-dashed border-slate-300 bg-slate-50/70 p-5 text-center text-sm text-muted-foreground transition hover:border-violet-300 hover:bg-violet-50/50">
                <ImagePlus size={22} /><span>{coverFile ? coverFile.name : "Add JPG, PNG or WEBP • maximum 5 MB"}</span>
