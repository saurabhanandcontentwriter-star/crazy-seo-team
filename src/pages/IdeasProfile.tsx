  ...
  <div className="min-h-screen bg-[#f8f9fc] dark:bg-background">
   <div className="mx-auto flex min-h-screen max-w-[1500px]">
    <aside className="sticky top-0 hidden h-screen w-[215px] shrink-0 flex-col border-r bg-background px-3 py-5 lg:flex">
      ...
      <Button onClick={()=>{setTab("posts");setShowPostComposer(true)}} className="mt-4 h-11 rounded-xl bg-gradient-to-r from-violet-600 to-blue-600 font-bold shadow-lg"><Plus className="mr-2 size-5"/>Create Post</Button>
      <div className="mt-5 rounded-2xl border bg-background p-3 shadow-sm">
        ...
        <div className="mt-3 space-y-1">
          ...
          <button onClick={()=>{setTab("posts");setShowPostComposer(true)}} className="flex w-full items-center gap-3 rounded-lg px-2 py-2 text-sm font-semibold hover:bg-muted"><Plus className="size-4 text-orange-500"/>Publish</button>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border p-4">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              ...
              <Input placeholder="X / Twitter URL" value={String(form.twitter_url||"")} onChange={e=>setForm(f=>({...f,twitter_url:e.target.value}))}/>
            </div>
          </div>
