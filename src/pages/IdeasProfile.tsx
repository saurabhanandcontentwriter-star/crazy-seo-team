    ...
    <main className="min-w-0 flex-1 px-3 py-4 sm:px-5 md:px-7 md:py-7">
      <div className="mx-auto max-w-[1180px]">
       <div className="relative mb-3 flex justify-end lg:hidden">
        <button type="button" aria-label={mobileMenuOpen ? "Close ANVYA navigation" : "Open ANVYA navigation"} aria-expanded={mobileMenuOpen} onClick={()=>setMobileMenuOpen(v=>!v)} className="flex size-11 items-center justify-center rounded-xl border border-slate-200 bg-white shadow-sm">
         {mobileMenuOpen ? <span className="text-2xl leading-none" aria-hidden="true">×</span> : <span className="flex flex-col gap-1" aria-hidden="true"><span className="block h-0.5 w-5 rounded-full bg-slate-700"/><span className="block h-0.5 w-5 rounded-full bg-slate-700"/><span className="block h-0.5 w-5 rounded-full bg-slate-700"/></span>}
         <span className="sr-only">{mobileMenuOpen ? "Close ANVYA navigation" : "Open ANVYA navigation"}</span>
        </button>
        {mobileMenuOpen && (
         <nav className="absolute right-0 top-12 z-50 w-[min(92vw,320px)] rounded-2xl border border-slate-200 bg-white p-2 shadow-xl dark:border-border dark:bg-background" aria-label="ANVYA mobile navigation">
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Home className="size-4"/><span>Home</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/explore")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Compass className="size-4"/><span>Explore</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/notifications")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Bell className="size-4"/><span>Notifications</span>{notificationCount>0&&<span className="ml-auto flex min-w-5 h-5 items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-bold text-white">{notificationCount>99?"99+":notificationCount}</span>}</button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);sessionStorage.setItem("ideas_open_messages","1");nav("/anvya/profile/"+(me||userId||"me"))}} className={"flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold "+(tab==="messages"?"bg-violet-100 text-violet-700 dark:bg-violet-950/50 dark:text-violet-300":"text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted")}><MessageCircle className="size-4"/><span>Messages</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/profile/"+(me||userId||"me"))}} className={"flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold "+(tab!=="messages"?"bg-violet-100 text-violet-700 dark:bg-violet-950/50 dark:text-violet-300":"text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted")}><UserCircle2 className="size-4"/><span>Profile</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/saved")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Bookmark className="size-4"/><span>Saved</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/communities")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Users className="size-4"/><span>Communities</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/events")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Calendar className="size-4"/><span>Events</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/premium")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Crown className="size-4"/><span>Premium</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/analytics")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><BarChart3 className="size-4"/><span>Analytics</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/settings")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><Settings2 className="size-4"/><span>Settings</span></button>
          <button type="button" onClick={()=>{setMobileMenuOpen(false);nav("/anvya/help")}} className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 dark:text-muted-foreground dark:hover:bg-muted"><HelpCircle className="size-4"/><span>Help</span></button>
         </nav>
        )}
       </div>
