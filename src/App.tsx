...
const App = () => <QueryClientProvider client={queryClient}><TooltipProvider><Toaster /><Sonner /><BrowserRouter><TrackingLayer /><Routes>
  <Route path="/" element={<Index />} /><Route path="/services" element={<Services />} /><Route path="/services/:slug" element={<ServiceDetail />} />
  <Route path="/seo-tools" element={<SEOTools />} /><Route path="/ai-tools" element={<AITools />} />
  <Route path="/classifieds" element={<Classifieds />} /><Route path="/classifieds/:category" element={<Classifieds />} /><Route path="/listing/:id" element={<Classifieds />} />
  <Route path="/post-ad" element={<PostAd />} /><Route path="/classified-dashboard" element={<ClassifiedDashboard />} /><Route path="/business-directory" element={<Classifieds />} /><Route path="/seller/:slug" element={<ClassifiedDashboard />} />
  <Route path="/about" element={<About />} /><Route path="/results" element={<Results />} /><Route path="/news" element={<News />} /><Route path="/blog" element={<Blog />} /><Route path="/blog/:slug" element={<BlogPost />} /><Route path="/faq" element={<FAQ />} />
