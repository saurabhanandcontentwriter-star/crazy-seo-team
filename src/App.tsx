...
import ClassifiedListing from "./pages/ClassifiedListing.tsx";
...
const AdminClassifieds = lazy(() => import("./pages/admin/Classifieds.tsx"));
...
<Route path="/classifieds" element={<Classifieds />} /><Route path="/classifieds/:category" element={<Classifieds />} /><Route path="/listing/:id" element={<ClassifiedListing />} /><Route path="/post-ad" element={<PostAd />} /><Route path="/classified-dashboard" element={<ClassifiedDashboard />} /><Route path="/business-directory" element={<Classifieds />} /><Route path="/seller/:slug" element={<ClassifiedDashboard />} />
...
<Route path="/admin" element={<AdminGuard><Suspense fallback={<AdminFallback />}><AdminLayout /></Suspense></AdminGuard>}><Route index element={<Suspense fallback={<AdminSkeleton />}><AdminHome /></Suspense>} /><Route path="live" element={<Suspense fallback={<AdminSkeleton />}><AdminLive /></Suspense>} /><Route path="blog" element={<Suspense fallback={<AdminSkeleton />}><AdminDashboard /></Suspense>} /><Route path="news" element={<Suspense fallback={<AdminSkeleton />}><AdminNews /></Suspense>} /><Route path="users" element={<Suspense fallback={<AdminSkeleton />}><AdminUsers /></Suspense>} /><Route path="subscribers" element={<Suspense fallback={<AdminSkeleton />}><AdminSubscribers /></Suspense>} /><Route path="analytics" element={<Suspense fallback={<AdminSkeleton />}><AdminAnalytics /></Suspense>} /><Route path="reports" element={<Suspense fallback={<AdminSkeleton />}><AdminReports /></Suspense>} /><Route path="operations" element={<Suspense fallback={<AdminSkeleton />}><AdminOperations /></Suspense>} /><Route path="crm" element={<Suspense fallback={<AdminSkeleton />}><AdminCrm /></Suspense>} /><Route path="crm/*" element={<Suspense fallback={<AdminSkeleton />}><AdminCrm /></Suspense>} /><Route path="classifieds" element={<Suspense fallback={<AdminSkeleton />}><AdminClassifieds /></Suspense>} /></Route>
