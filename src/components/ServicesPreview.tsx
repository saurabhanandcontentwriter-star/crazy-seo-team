...
const items = [
  ...
  { icon: Gauge, title: "SEO Audit", desc: "180-point technical, content and AI-visibility audit.", slug: "technical-audits" },
  { icon: Building2, title: "Enterprise SEO", desc: "Governance, scale and stakeholder-ready reporting.", slug: "semantic-seo" },
  { icon: PenLine, title: "Content Marketing", desc: "Editorial systems that compound organic traffic.", slug: "blog-writing" },
