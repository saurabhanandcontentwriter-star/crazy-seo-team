        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Button size="lg" className="gradient-bg text-primary-foreground hover:opacity-90 gap-2 text-base px-8 py-6" onClick={() => setDialogOpen(true)}>
                Start Growing Today <ArrowRight size={18} />
              </Button>
              <Button size="lg" variant="outline" className="text-base px-8 py-6" onClick={() => document.getElementById("results")?.scrollIntoView({ behavior: "smooth" })}>
                View Our Work
              </Button>
            </div>
          ...
          <div className="relative">
            <div className="hero-card-bg rounded-2xl p-6 shadow-2xl">
